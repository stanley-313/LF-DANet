...
def parse_args():
    ...
    parser.add_argument('--trainset_dir', type=str, default='/home/hjadmin/smbu/dataset/LFSR/data_for_training/SR_5x5_4x/')
    parser.add_argument('--testset_dir', type=str, default='/home/hjadmin/smbu/dataset/LFSR/data_for_test/')
    ...
    parser.add_argument('--model_name', type=str, default='wo_sub')
    parser.add_argument('--load_pretrain', type=int, default=0)
    parser.add_argument('--model_path', type=str, default='./log/model_1_2/model_1_2_4xSR_5x5_epoch_45.pth.tar')
    parser.add_argument('--shear', type=int, default=0)
...
def train(cfg, train_loader, test_Names, test_loaders):
    ...
    optimizer = torch.optim.Adam([{'params': [paras for paras in net.parameters() if paras.requires_grad == True]}], lr=cfg.lr)
